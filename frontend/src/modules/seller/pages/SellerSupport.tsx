...
export default function SellerSupport() {
  ...
  useEffect(() => {
    ...
    socket.emit("support:join", { sellerId });
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-neutral-200 overflow-hidden flex flex-col h-[calc(100vh-280px)] min-h-[500px]">
            ...
            <div
              ...
              {loading ? (
                ...
                <div className="h-full flex flex-col items-center justify-center text-center p-8">
                  ...
                  <p className="text-neutral-500 text-sm mt-1 max-w-[240px]">
                    Mention your query below and our team will assist you
                    immediately.
                  </p>
                </div>
              ) : (
            ...
            <form
              ...
              <p className="text-[10px] text-center text-neutral-400 mt-3">
                Usually replies in under 5 minutes â€¢ Available 24/7
              </p>
            </form>
          </div>
        </FeatureGate>
