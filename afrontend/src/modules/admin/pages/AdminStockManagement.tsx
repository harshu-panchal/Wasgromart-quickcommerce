          ...
          <div className="p-4 border-b border-neutral-200">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={() => navigate("/admin/product/bulk-upload")}
                  className="bg-orange-500 hover:bg-orange-600 text-white px-3 py-1.5 rounded text-sm font-medium flex items-center gap-1 transition-colors"
                >
                  <svg
                    width="14"
                    height="14"
