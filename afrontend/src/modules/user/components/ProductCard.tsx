...
export default function ProductCard({
  ...
  // Wishlist state is sourced from the shared WishlistContext so we don't hit
  // GET /customer/wishlist once per card.
  const productIdForWishlist = String((product as any).id || product._id || '');
  const { isWishlisted, toggleWishlist } = useWishlist(productIdForWishlist);
