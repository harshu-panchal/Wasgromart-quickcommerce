          ...
          <section>
            ...
            <div className="space-y-3">
              {notification.items.map((item, index) => (
                <div key={index} className="flex justify-between items-start gap-3 py-2 border-b border-neutral-100 last:border-0">
                  <div className="flex items-start gap-3 flex-1 min-w-0">
                        ...
                        <img
                          ...
                          onError={(e) => {
                            ...
                            if (parent && !parent.querySelector('.product-img-fallback')) {
                              ...
                              fb.className = 'product-img-fallback w-full h-full flex items-center justify-center text-neutral-300';
                              fb.innerHTML = '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 16l5-5 13 13"/><circle cx="9" cy="9" r="2"/></svg>';
                              parent.appendChild(fb);
                            }
                          }}
                        />
                      ) : (
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-neutral-300">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-medium text-neutral-800 line-clamp-2">{item.productName}</p>
                  ...
                  <p className="font-bold text-neutral-800 whitespace-nowrap">₹{item.total.toFixed(2)}</p>
                </div>
              ))}
